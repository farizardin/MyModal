        ...
        <div class="row">
                    ...
                    <tr>
                       <td style="vertical-align:middle;"><?php echo $i; ?></td>
                        ...
                        <form method="post" action="<?php echo site_url('Pemodal/DetailProposal/'.$row->id)?>">
                                ...
                                <a onclick="proposalConfirm('<?php echo site_url('Pemodal/ConfirmPemodal/'.$row->id) ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-success btn-sm"></i>Terima</a>
                                <a onclick="deleteConfirm('<?php echo site_url('Pemodal/Tolak/'.$row->id) ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-danger btn-sm"></i>Tolak</a>
                            </form>
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Pengajuan Masuk</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                            </button>
                        </div>
                    <div class="modal-body">Apakah anda yakin untuk mengPengajuan Masuk ini?</div>
            ...
            <!-- fieldsets -->
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
                                    <input type="number" required id="dana_setuju" placeholder="Dana Disetujui" name="danadisetujui" class="form-control aspect_list" style="border-radius:0px !important;">
                                </div>
                            </div>
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
