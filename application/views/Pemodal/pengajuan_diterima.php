    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Pengajuan Diterima</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <div class="card table-responsive" style="border-radius: 0px !important;">
                ...
                <?php } ?>
                <div class="card-header">
                <h3 class="card-title">Pengajuan Diterima</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover" style="font-size:10pt; vertical-align:middle; text-align:center;">
                    ...
                    <tr>
                       ...
                       <p><b>JUDUL</b>: <?php echo $row->judul?><br>
                                ...
                                <b>Laporan Keuangan</b>: <a target="_blank" href="<?php echo base_url($row->fileLap);?>">Download Laporan Keuangan</a><p>
                            </p>
                        </td>
                        ...
                        <form method="post" action="<?php echo site_url('Admin/DetailProposal/'.$row->id)?>">
                                ...
                                <a onclick="deleteConfirm('<?php echo site_url('Proposal/Pembatalan/')?>')" href="#!" style="border-radius:0px !important;" class="btn btn-danger btn-sm"></i>Hapus</a>
                            </form>
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Pengajuan Diterima</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">Apakah anda yakin untuk mengPengajuan Diterima ini?</div>
