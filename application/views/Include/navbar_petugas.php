...
<ul class="navbar-nav ml-auto">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 450px !important;">
    ...
    <a href="<?php echo base_url("Admin"); ?>" class="brand-link">
      <img src="<?php echo base_url("assets/img/logo.png"); ?>" alt="Logo MyModal" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Admin/ProposalMasuk');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Admin/ProposalDisetujui');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Disetujui</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Admin/ProposalDitolak');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
