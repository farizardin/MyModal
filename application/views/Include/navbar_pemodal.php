  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 450px !important;">
    ...
    <a href="<?php echo base_url("Petugas"); ?>" class="brand-link">
      <img src="<?php echo base_url("assets/img/logo.png"); ?>" alt="Logo MyModal ITS" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">MyModal</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('Pemodal');?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/PengajuanPemodal');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Pengajuan Pemodal</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/ProposalPending');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Pending</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/ProposalDiterima');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Diterima</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/ProposalDitolak');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/PengajuanMasuk');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Peminjam Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/PengajuanDiterima');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Peminjam Diterima</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/PengajuanDitolak');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Peminjam Ditolak</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/DanaMasuk');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Dana Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Pemodal/DanaKeluar');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Dana Keluar</p>
                </a>
              </li>
