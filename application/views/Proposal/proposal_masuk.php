...
<?php require_once(dirname(dirname(__FILE__)) . '/Peminjam/navbar_dosen.php'); ?>
</head>
                       ...
                       <td style="vertical-align:middle;"><?php echo $i; ?></td>
                        <td style=" text-align:left; ">
                            <p>
                                ...
                                <b>STATUS</b>: <i><?php if(($row->idstatdos1 == 1 || $row->idstatdos2 == 1)){
                        ...
                        <form method="post" action="<?php echo site_url('Mahasiswa/DetailProposal')?>">
                                ...
                                <a onclick="proposalConfirm('<?php echo site_url('Dosen/ConfirmProposal/'.$row->id) ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-success btn-sm"></i>Konfirmasi</a>
                                <a onclick="deleteConfirm('<?php echo site_url('Dosen/TolakProposal/'.$row->id) ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-danger btn-sm"></i>Tolak</a>
                            </form>
