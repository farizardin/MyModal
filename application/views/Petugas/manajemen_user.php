    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="card table-responsive" style="border-radius: 0px !important;">
                ...
                <div class="card-body">
                <div>
                        <a style="float:right" onclick="proposalConfirm('<?php echo site_url('Admin/TambahUser') ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-primary btn-sm"></i>Tambah User</a></div>
                    ...
                    <tr>
                       <td style="vertical-align:middle;"><?php echo $i; ?></td>
                        <td style=" text-align:left; ">
                            <p><b>NAMA</b>: <?php echo $row->nama_user?><br>
                                <b>USERNAME</b>: <?php echo $row->username?><i></i><br>
                                <b>ALAMAT</b>: <?php echo $row->alamat?><br>
                                <b>ROLE</b>: <?php echo $row->nama_role?><br>
                            </p>
                        </td>
                        <td style="vertical-align:middle; ">
                        <form method="post" action="">
                                <input type="hidden" name="id_proposal" value="">
                                <a onclick="deleteConfirm('<?php echo site_url('Admin/HapusUser/'.$row->id_user) ?>')"href="#!" style="border-radius:0px !important;" class="btn btn-danger btn-sm"></i>Hapus</a>
                            </form>
                        </td>
                    </tr>
                    <?php $i++;} ?>   
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">Tambah User</div>
                        <form id="msform" class="form-group" action="" method="post">
            <!-- fieldsets -->
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
                                <select class="form-control" id="role" name="role" data-fv-field="id_sumber_dana">
                                    <option value="" selected disabled>-- Pilih Role --</option>  
                                    <option value="3">Admin</option>
                                    <option value="1">Pemodal</option>
                            ...
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
                                    <input class="form-control" placeholder="Nama" type="name" name="name" required>
                                </div>
                            </div>
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
                            ...
                            <div class="row" style="margin-left:2rem;padding-bottom:1rem;">
                                <div class="col-5">
                                <input type="submit" name="submit" id="btn-confirm" class="btn btn-primary" value="Tambah">
            ...
            <div class="modal fade" id="tolakModal" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Hapus User</div>
                        <div class="modal-footer">
                            <a id="btn-tolak" class="btn btn-danger" href="#">Hapus</a>
