    ...
    <div class="menu-logo">
        <div class="navbar-brand">
          <span class="navbar-logo">
              ...
              <!-- <img class="imglogo" src="<-?php echo base_url("assets/images/logo-100x100.png") ?>" alt="LOGO ITS KEWIRAUSAHAAN" title=""> -->
                    
          </span>
            <span class="navbar-caption-wrap"><a class="navbar-caption text-primary display-4" href="#top">MyModal<br></a></span>
          </div>
     </div>
