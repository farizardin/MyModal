...
<ul class="navbar-nav ml-auto">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 450px !important;">
    <!-- Brand Logo -->
    <a href="<?php echo base_url("Dosen"); ?>" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('Dosen/ProposalMasuk');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Dosen/ProposalTerkonfirmasi');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Proposal Terkonfirmasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('Dosen/ProposalDitolak');; ?>" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
