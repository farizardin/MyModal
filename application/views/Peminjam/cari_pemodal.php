    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Cari Pemodal</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <div class="card table-responsive" style="border-radius: 0px !important;">
                ...
                <?php } ?>
                <div class="card-header">
                <h3 class="card-title">Cari Pemodal</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-hover" style="font-size:10pt; vertical-align:middle; text-align:center;">
                    ...
                    <tr>
                        <th style="min-width:1rem;max-width:1.5rem;">NO.</th>
                        <th style="min-width:20rem;max-width:20rem;">DESKRIPSI</th>
                        <th style="max-width:7rem;">ABSTRAKSI</th>
                        <th style="max-width:10rem;min-width:10rem">AKSI</th>
                    </tr>
                    </thead>
                    <tbody> 
                    ...
                    <tr>
                       ...
                       <td style=" text-align:left; ">
                        ...
                        <td style="vertical-align:middle; ">
                        <form method="post" action="<?php echo site_url('Peminjam/DetailProposal/'.$row->id)?>">
                                ...
                                <a href="<?php echo site_url('Peminjam/ProposalPengajuan/'.$row->id)?>" style="border-radius:0px !important;" class="btn btn-success btn-sm"></i>Ajukan</a>
                            </form>
                        </td>
                    </tr>
                    <?php $i++;} ?>   
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Cari Pemodal</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">Apakah anda yakin untuk mengCari Pemodal ini?</div>
