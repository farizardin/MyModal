            ...
            <div class="card table-responsive" style="border-radius: 0px !important;">
                ...
                <table id="example1" class="table table-bordered table-striped table-hover" style="font-size:10pt; vertical-align:middle; text-align:center;">
                    ...
                    <tr>
                        ...
                        <th style="min-width:5rem;max-width:5rem;">DESKRIPSI</th>
                        <th style="max-width:10rem;">ABSTRAKSI</th>
                    ...
                    <tr>
                       <td style="vertical-align:middle;"><?php echo $i; ?></td>
                        ...
                        <form method="post" action="<?php echo site_url('Peminjam/DetailProposal/'.$row->id)?>">
                                ...
                                <a onclick="deleteConfirm('<?php echo site_url('Peminjam/Hapus/')?>')" href="#!" style="border-radius:0px !important;" class="btn btn-danger btn-sm"></i>Batal</a>
                            </form>  
                        </td>
                    </tr>
                    <?php $i++;} ?>   
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Proposal Pending</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">Apakah anda yakin untuk mengProposal Pending ini?</div>
