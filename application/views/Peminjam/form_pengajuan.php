    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="card table-responsive" style="border-radius: 0px !important;">
                ...
                <?php } ?>
                        <!-- Grid -->
                <form id="msform" class="form-group" action="<?php echo site_url('Peminjam/InsertProposal')?>" method="post" enctype="multipart/form-data">
            <!-- fieldsets -->
                <fieldset>
                ...
                <div class="row" style="padding-bottom:1rem;">
                    <div class="col-3" style="margin-top:5px; text-align:left;">
                        Mengajukan Kepada<span style="color:red;"></span>
                    </div>
                    <div class="col-6" style="text-align:left;">
                       : <?php echo $proposal_data->judul;?><input type="hidden" id="proposal_pemodal" name="proposal_pemodal" value="<?php echo $proposal_data->id;?>">
                    </div>
                    <div class="col-3">
                        <span class="error_form" id="bidang_error">
                        </span>
                ...
                <div class="row" style="padding-bottom:1rem;">
                    <div class="col-3" style="margin-top:5px; text-align:left;">
                        Dana Disediakan<span style="color:red;"></span>
                    </div>
                    <div class="col-6" style="text-align:left;">
                ...
                <div class="row" style="padding-bottom:1rem;">
                    <div class="col-3" style="padding-top:5px; text-align:left;">
                        Permintaan Dana<span style="color:red;">*</span>
                    </div>
                    <div class="col-6">
                ...
                <div class="row" style="padding-bottom:1rem;">
                    <div class="col-3" style="padding-top:5px; text-align:left;">
                        Jaminan<span style="color:red;">*</span>
                    </div>
                    <div class="col-6">
                    <input type="file" class="form-control-file border" name="jaminan">
                    </div>
                    <div class="col-3">
                        <span class="error_form" id="abstrak_error">
                        </span>
